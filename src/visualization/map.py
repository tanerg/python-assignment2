...
def create_interactive_covid_map(data_dir):
    # Create output widget to contain the map
    ...
    with map_output:
        ...
        levels = {
            "Municipality": {
                "monthly": gpd.read_file(os.path.join(data_dir, "agg_mun_monthly.geojson")),
                "yearly": gpd.read_file(os.path.join(data_dir, "agg_mun_yearly.geojson"))
            },
            "Province": {
                "monthly": gpd.read_file(os.path.join(data_dir, "agg_prov_monthly.geojson")),
                "yearly": gpd.read_file(os.path.join(data_dir, "agg_prov_yearly.geojson"))
            },
            "National": {
                "monthly": gpd.read_file(os.path.join(data_dir, "agg_nl_monthly.geojson")),
                "yearly": gpd.read_file(os.path.join(data_dir, "agg_nl_yearly.geojson"))
            }
        }
